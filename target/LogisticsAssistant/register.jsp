                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-mailAddress">E-mail</label>
                                        <input type="text" name="form-mailAddress" placeholder="邮箱地址" class="form-mailAddress form-control" id="form-mailAddress" required="required">
                                    </div>
			                        <div class="form-group">
                                    ...
                                    <!-- 表单验证 -->
                                    <div class="form-group">
                                        <label class="sr-only" for="form-key">key</label>
                                        <input type="text" name="form-key" placeholder="输入您的验证码..." class="form-key form-control" id="form-key" required="required">
                                    </div>
